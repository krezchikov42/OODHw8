...
public interface Command<T> {
  ...
  /**
   * Get the current state of the {@code Command}. An example for a {@link Move}
   * cs3500.animator.command would be: (100.0,100.0) An example for a {@link ChangeColor}
   * cs3500.animator.command would be: (1.0,0.0,0.0)
   *
  ...
  /**
   * Visit the given {@link AnimationObject} and call the correct method to place this {@code
   * Command} in the way to the {@link AnimationObject}.
   *
  ...
  /**
   * Determine if this {@code Command} conflicts with a given cs3500.animator.command. The two
   * commands conflict if two conditions are true: <ul> <li>The two commands are of the same
   * type.</li> <li>The two commands' active times overlap.</li> </ul>
   *
