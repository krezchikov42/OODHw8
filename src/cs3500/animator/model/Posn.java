...
/**
 * This interface represents a position in R2. (x, y). <p> The y value of this posn is interpreted
 * as growing positive below the x axis and positive above the x axis. </p> <p> | X = -    |  X = +
 * Y = -    |  Y = - | | ---------------------------- | X = -     |  X = + Y = +     |  Y = + | |
 * </p>
 *
 * <p> I have made the x and y values doubles in order that partially completed animations can be as
