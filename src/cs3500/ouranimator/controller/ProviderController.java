...
import cs3500.ouranimator.adapters.ShapeToAnimationObjectAdapter;
import cs3500.ouranimator.model.EasyAnimatorOperations;
import cs3500.ouranimator.view.TextView;
...
public class ProviderController implements Controller {
  ...
  public String getTextFromTextualView() {
    ...
    if (view instanceof VerboseView) {
      return new TextView()
          .getText(model.getShapes(), model.getActions(), rate, model.getEndTime());
    } else if (view instanceof SVGView) {
      return new cs3500.ouranimator.view.SVGView()
          .getText(model.getShapes(), model.getActions(), rate, model.getEndTime());
    } else {
